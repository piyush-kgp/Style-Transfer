...
def model_nn(model, sess, input_image, output_file, num_iterations = 100):
    print('check_9')
...
def stylize(content_file, style_file, outfile):
    ...
    model_nn(model=model, sess = sess, input_image = generated_image, output_file = outfile, num_iterations = 100)
    print('check_final')


if __name__=='__main__':
    stylize(content_file='piyush.jpeg', style_file='starry_nights.jpeg', outfile='outfile.jpeg')
