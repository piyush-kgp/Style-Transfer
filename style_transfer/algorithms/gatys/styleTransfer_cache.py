...
class GatysStyleTransfer(object):
    ...
    def content_model(self):
        return self.get_intermediate_model(layer_name=self.config.content_cost_layer)


    @property
    def style_models(self):
        return {layer: self.get_intermediate_model(layer_name=layer) for layer in self.config.style_cost_layers}
